...
RETS.prototype.getMetadata = function (type, id, format) {
    ...
    var options = {
        Type: type || 'METADATA-RESOURCE',
        ID: id || 'Property',
        Format: format || 'STANDARD-XML'
    };

    return request(this.session, 'GetMetadata', { qs: options }, function(err){
 ...
 * @param  {boolean} location Return binary or as URL
 */
RETS.prototype.getObject = function (resource, type, id, location) {
    var options = {
